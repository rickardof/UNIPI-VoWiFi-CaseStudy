# original source code: https://github.com/Spinlogic/epdg_discoverer/blob/master/ikev2_class.py
...
from scapy.contrib.ikev2 import IKEv2, IKEv2_Transform, IKEv2_KE, IKEv2_Notify, IKEv2_Proposal, IKEv2_SA, IKEv2_Nonce
...
class EpdgIKEv2(object):
    # ENCRYPTION
    ENC_NULL = IKEv2_Transform(
        next_payload="Transform", transform_type="Encryption", transform_id=ikev2_crypto.EncrId.ENCR_NULL, length=8
    )
    ENC_DES = IKEv2_Transform(
        next_payload="Transform", transform_type="Encryption", transform_id=ikev2_crypto.EncrId.ENCR_DES, length=8
    )
    ENC_3DES = IKEv2_Transform(
        next_payload="Transform", transform_type="Encryption", transform_id=ikev2_crypto.EncrId.ENCR_3DES, length=8
    )
    ENC_AES_128 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_CBC,
        length=12,
        key_length=128,
    )
    ENC_AES_192 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_CBC,
        length=12,
    ...
    ENC_AES_CTR_128 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_CTR,
        length=12,
        key_length=128,
    )
    ENC_AES_CTR_192 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_CTR,
        length=12,
    ...
    ENC_AES_CTR_256 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_CTR,
        length=12,
    ...
    AES_GCM_8_128 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_8,
        length=12,
        key_length=128,
    )
    AES_GCM_8_192 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_8,
        length=12,
    ...
    AES_GCM_12_128 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_12,
        length=12,
        key_length=128,
    )
    AES_GCM_12_192 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_12,
        length=12,
    ...
    AES_GCM_12_256 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_12,
        length=12,
    ...
    AES_GCM_16_128 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_16,
        length=12,
        key_length=128,
    )
    AES_GCM_16_192 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_16,
        length=12,
    ...
    AES_GCM_16_256 = IKEv2_Transform(
        next_payload="Transform",
        transform_type="Encryption",
        transform_id=ikev2_crypto.EncrId.ENCR_AES_GCM_16,
        length=12,
    ...
    # PRF
    PRF_MD5 = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_HMAC_MD5
    )
    PRF_SHA1 = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_HMAC_SHA1
    )
    PRF_AES128_CBC = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_AES128_XCBC
    )
    PRF_SHA2_256 = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_HMAC_SHA2_256
    )
    PRF_SHA2_384 = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_HMAC_SHA2_384
    )
    PRF_SHA2_512 = IKEv2_Transform(
        next_payload="Transform", transform_type="PRF", transform_id=ikev2_crypto.PrfId.PRF_HMAC_SHA2_512
    )

    # INTEGRITY
    INT_NULL = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_NONE
    )
    INT_MD5_96 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_HMAC_MD5_96
    )
    INT_SHA1_96 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_HMAC_SHA1_96
    )
    INT_AES_XCBC_96 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_AES_XCBC_96
    )
    INT_SHA2_256_128 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_HMAC_SHA2_256_128
    )
    INT_SHA2_384_192 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_HMAC_SHA2_384_192
    )
    INT_SHA2_512_256 = IKEv2_Transform(
        next_payload="Transform", transform_type="Integrity", transform_id=ikev2_crypto.IntegId.AUTH_HMAC_SHA2_512_256
    )

    # DH
    DH_768MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_1
    )
    DH_1024MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_2
    )
    DH_1536MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_5
    )
    DH_2048MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_14
    )
    DH_3072MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_15
    )
    DH_4096MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_16
    )
    DH_6144MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_17
    )
    DH_8192MODP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_18
    )
    DH_256ECP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_19
    )
    DH_384ECP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_20
    )
    DH_512ECP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_21
    )
    DH_1024MODP_160POS = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_22
    )
    DH_2048MODP_224POS = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_23
    )
    DH_2048MODP_256POS = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_24
    )
    DH_192ECP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_25
    )
    DH_224ECP = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_26
    )
    DH_224ECP_B = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_27
    )
    DH_256ECP_B = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_28
    )
    DH_384ECP_B = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_29
    )
    DH_512ECP_B = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_30
    )
    DH_X25519 = IKEv2_Transform(
        next_payload="Transform", transform_type="GroupDesc", transform_id=ikev2_crypto.DhId.DH_31
    )
    ...
    def validate_security_assotiations(request, answer):
        ...
        return (
            ikev2_crypto.EncrId(encr_ans[0][0]),
            encr_ans[0][1],
            ikev2_crypto.PrfId(prf_ans[0]),
            ikev2_crypto.IntegId(integ_ans[0]),
            ikev2_crypto.DhId(dh_ans[0]),
        )
    ...
    def create_sa_proposal_list(sa_list, proto="IKE"):
        ...
        for transform_list in reversed(sa_list):
            ...
            if not head:
                ...
                head = (
                    IKEv2_Proposal(next_payload="Proposal", proto=proto, trans_nb=len(transform_list), trans=transforms)
                    / head
                )
        return head
    ...
    def ike_sa_init_create_packet(self, sa_list, key_exchange, cookie=None):
        ...
        packet_sa_init = (
            EpdgIKEv2.IPv4v6(dst=self.dst_addr)
    ...
    def ike_sa_init_analyze_response(self, request, answer):
        ...
        try:
            if IKEv2_KE in answer and IKEv2_Nonce in answer:
                self.encr_id, self.encr_key_len, self.prf_id, self.integ_id, self.dh_id = (
                    self.validate_security_assotiations(request, answer)
                )
                EpdgIKEv2.validate_key_exchange(request, answer, self.dh_id)
                self.dh_shared_key = ikev2_crypto.dh_calculate_shared_key(
                    answer[IKEv2_KE].group, answer[IKEv2_KE].ke, self.dh_key_size, self.dh_private_key
                )
