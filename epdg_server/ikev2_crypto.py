# original source code: https://github.com/aatlasis/yIKEs/blob/main/crypto.py
...
DH_GROUPS = {
    ...
    DhId.DH_19: (
        DHType.DH_ECDH,
        ec.SECP256R1(),
    ),  # (0xFFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF, (0x6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5, -3), 32),
    DhId.DH_20: (
        DHType.DH_ECDH,
        ec.SECP384R1(),
    ),  # (0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF, (0xAA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB73617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F, -3), 48),
    DhId.DH_21: (
        DHType.DH_ECDH,
        ec.SECP521R1(),
    ...
    DhId.DH_25: (
        DHType.DH_ECDH,
        ec.SECP192R1(),
    ),  # (0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF, (0x188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF101207192B95FFC8DA78631011ED6B24CDD573F977A11E794811, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC), 24),
    DhId.DH_26: (
        DHType.DH_ECDH,
        ec.SECP224R1(),
    ),  # (0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001, (0xB70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE), 28),
    ...
    DhId.DH_28: (
        DHType.DH_ECDH,
        ec.BrainpoolP256R1,
    ),  # (0xA9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377, (0x8BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997, 0x7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9), 32),
    DhId.DH_29: (
        DHType.DH_ECDH,
        ec.BrainpoolP384R1,
...
class Integrity:
    ...
    def __init__(self, transform):
        self.hasher, self.key_size, self.hash_size = (
            self.DIGESTS[transform] if type(transform) is IntegId else self.DIGESTS_1[transform]
        )
...
def create_key(
    PRF_id, INTEG_id, ENCR_id, ENCR_keylen, shared_secret, my_nonce, peer_nonce, my_spi, peer_spi, old_sk_d=None
):
    prf = Prf(PRF_id)
    ...
    sk_d, sk_ai, sk_ar, sk_ei, sk_er, sk_pi, sk_pr = keymat_fmt.unpack(
...
def dh_generate_key(group):
    ...
    if dh_type == DHType.DH_MODP:
        ...
        dh_public_key_bytes = dh_public_numbers.x.to_bytes(dh_key_size, "big") + dh_public_numbers.y.to_bytes(
            dh_key_size, "big"
        )
...
def dh_calculate_shared_key(group, peer_public_key_bytes, dh_key_size, dh_private_key):
    ...
    if dh_type == DHType.DH_MODP:
        ...
        peer_public_numbers = dh.DHPublicNumbers(
            int.from_bytes(peer_public_key_bytes, byteorder="big"), dh.DHParameterNumbers(p, g)
        )
        ...
        peer_public_numbers = ec.EllipticCurvePublicNumbers(
            int.from_bytes(peer_public_key_bytes[:dh_key_size], "big"),
            int.from_bytes(peer_public_key_bytes[dh_key_size:], "big"),
            params,
        )
        peer_public_key = peer_public_numbers.public_key()
